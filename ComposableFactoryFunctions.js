...
const BaseMover = stampit()
	.methods({
		move(x, y) {
			this.pos_x = x; //'this' should be accessable from inside the method.
			this.pos_y = y;
...
gojiro.move(1,1); //to fix refer to: https://medium.com/javascript-scene/what-is-this-the-inner-workings-of-javascript-objects-d397bfa0708a
gojiro.slash('left');
gojiro.shoot('right');
